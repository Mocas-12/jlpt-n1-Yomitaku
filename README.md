...
- ✅ **Built-in question bank**: 266 sets / 515 questions covering all six question types — **original mock questions** written against the official "test goals of each large question" (ability points, question style), with each set clearly labeled "not a past paper"
